...
let project = Project(
    ...
    targets: [
        Target(
            ...
            resources: [
                "Targets/Authorization/Resources/**",
            ],
            copyFiles: nil,
            headers: .headers(
                public: "Targets/Authorization/Sources/**",
                private: nil,
                project: nil,
            ...
            settings: .settings(
                base: [
                    ...
                    "PRODUCT_BUNDLE_IDENTIFIER": .string("com.jaemyeong.Authorization"),
        ...
        Target(
            ...
            product: .unitTests,
            productName: nil,
            bundleId: "com.jaemyeong.AuthorizationTests",
            deploymentTarget: .iOS(targetVersion: "13.0", devices: [.iphone]),
            infoPlist: nil,
            sources: [
                "Targets/Authorization/Tests/**"
            ],
            resources: nil,
            copyFiles: nil,
            headers: nil,
            ...
            settings: .settings(
                base: [
                    ...
                    "DEVELOPMENT_TEAM": .string("67YPF88Z6T"),
                    "GENERATE_INFOPLIST_FILE": .string("YES"),
                    "PRODUCT_BUNDLE_IDENTIFIER": .string("com.jaemyeong.AuthorizationTests"),
    ...
    additionalFiles: [
        .folderReference(path: "Authorization.docc"),
    ],
