...
let project = Project(
    ...
    targets: [
        Target(
            ...
            product: .framework,
            productName: nil,
            bundleId: "com.jaemyeong.Core",
            deploymentTarget: .iOS(targetVersion: "13.0", devices: [.iphone]),
            infoPlist: nil,
            sources: [
                "Targets/Core/Sources/**"
            ],
            resources: [
                "Targets/Core/Resources/**",
            ],
            copyFiles: nil,
            headers: .headers(
                public: "Targets/Core/Sources/**",
                private: nil,
                project: nil,
            ...
            settings: .settings(
                base: [
                    ...
                    "PRODUCT_BUNDLE_IDENTIFIER": .string("com.jaemyeong.Core"),
        ...
        Target(
            ...
            product: .unitTests,
            productName: nil,
            bundleId: "com.jaemyeong.CoreTests",
            deploymentTarget: .iOS(targetVersion: "13.0", devices: [.iphone]),
            infoPlist: nil,
            sources: [
                "Targets/Core/Tests/**"
            ...
            settings: .settings(
                base: [
                    ...
                    "DEVELOPMENT_TEAM": .string("67YPF88Z6T"),
                    "GENERATE_INFOPLIST_FILE": .string("YES"),
                    "PRODUCT_BUNDLE_IDENTIFIER": .string("com.jaemyeong.CoreTests"),
    ...
    additionalFiles: [
        .folderReference(path: "Core.docc"),
    ],
